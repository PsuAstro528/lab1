...
response_1a = missing  # REPLACE missing with your responces as Markdown text like md"your response" 
...
if  ready_to_plot && !ismissing(compare_var_calcs(3)) 
...
if ready_to_plot && !ismissing(compare_var_calcs(3)) && !ismissing(compare_var_calcs_online(3))
	local N_list = [2^n for n in 2:20]
	local plt = plot()
	local true_mean = jd_sept1_2021
